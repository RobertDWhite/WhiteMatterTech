...
- [Sola Coffea: A Native iOS App for Coffee Obsessives](/posts/sola-coffea/) — the iOS app I eventually wrote to track everything this gear produces.
- [Live Better with Circadian Lighting](/posts/live-better-with-circadian-lighting/) — the other half of a workable home office: light that matches the hour.
- [A Quick Note on Leading Geographically Dispersed Teams](/posts/a-quick-note-on-leading-geographically-dispersed-teams/) — the working arrangement this gear list assumes.
